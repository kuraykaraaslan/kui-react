...
export function ImageGallery({
  ...
  // Sync when the prop changes from outside (e.g. parent adds images)
  ...
  /* — Reorder helpers (via context menu) ————————————————————————————————— */
    ...
    <>
      ...
      {lightbox && isOpen && activeImage && (
        ...
        >
          ...
          {/* Caption */}
          {activeImage.caption && (
            <p className="shrink-0 text-center text-white/80 text-sm px-6 py-2">
              {activeImage.caption}
            </p>
          )}
